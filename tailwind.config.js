  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        testimonialMobile: "0px 0.58px 0.58px 0px rgba(0, 0, 0, 0.25)",
        testimonialMobileArrows: "0px 1.83px 1.83px 0px rgba(0, 0, 0, 0.25)",
        dbButtonActive: "0px 12.34px 37.01px rgba(136, 51, 255, 0.1)",
        dbButton: "0px 2.47px 6.17px rgba(38, 51, 77, 0.03)",
      },
      backgroundImage: {
        "feature-ellipse": "url('/src/assets/features/feature-ellipse.png')",
        "footer-ellipse": "url('/src/assets/features/ellipse-footer.png')",
